...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_TOAD_HEADPHONES, -2510, -7777, 10360, 0, 0, 0, 0x01020000, bhvToadHeadphones),
		OBJECT(MODEL_TOAD_HEADPHONES, 2451, -7777, 8734, 0, 0, 0, 0x01030000, bhvToadHeadphones),
		...
		OBJECT(MODEL_TOAD_HEADPHONES, 1850, -4007, 2366, 0, 0, 0, 0x00000000, bhvToadHeadphones),

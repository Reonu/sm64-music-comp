...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		WARP_NODE(0x80, LEVEL_BOB, 0x01, 0x909, WARP_NO_CHECKPOINT),
		WARP_NODE(0x90, LEVEL_BOB, 0x01, 0x80, WARP_NO_CHECKPOINT),
		WARP_NODE(0x99, LEVEL_BOB, 0x01, 0x80, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_TOAD_HEADPHONES, -4463, -4007, 3668, 0, 0, 0, 0x00960000, bhvToadHeadphones),
		...
		OBJECT(MODEL_HMC_WOODEN_DOOR, 4354, -4006, 4952, 0, -90, 0, 0x00800000, bhvDoorWarp),
		OBJECT(MODEL_HMC_WOODEN_DOOR, 4354, -4006, 7240, 0, -90, 0, 0x00900000, bhvDoorWarp),
		OBJECT(MODEL_HMC_WOODEN_DOOR, 4354, -4006, 10965, 0, -90, 0, 0x00990000, bhvDoorWarp),
		...
		OBJECT(MODEL_TOAD_HEADPHONES, 2847, -5251, 5905, 0, 0, 0, 0x010A0000, bhvToadHeadphones),

...
const GeoLayout bob_area_4_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(5, bob_dl_A_Part1_mesh_layer_5),
		GEO_CLOSE_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(1, 346, -2905, 18240, bob_dl_B_Stalactite_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, 1004, -2905, 17625, bob_dl_B_Stalactite_001_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, 2031, -2905, 18154, bob_dl_B_Stalactite_002_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, -2129, -2901, 17333, bob_dl_B_Stalactite_003_mesh_layer_1),
		...
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(5, bob_dl_Z_background_mesh_layer_5),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};

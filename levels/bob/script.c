...
const LevelScript level_bob_entry[] = {
	...
	AREA(3, bob_area_3),
		...
		OBJECT(MODEL_MR_BLIZZARD, -4709, -7545, 6592, 0, 0, 0, 0x00000000, bhvMrBlizzard),
		OBJECT(MODEL_NONE, -3851, -8200, 7091, 0, 0, 0, 0x00000000, bhvBirdsSoundLoop),
		OBJECT(MODEL_NONE, -4236, -7545, 6073, 0, 0, 0, 0x00000000, bhvSnap2d),

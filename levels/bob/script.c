...
const LevelScript level_bob_entry[] = {
	...
	AREA(3, bob_area_3),
		...
		OBJECT(MODEL_WOOD_PLATFORM, -7743, -2899, 6073, 0, -180, 0, 0x00500000, bhvWoodPlatform),
	...
	AREA(4, bob_area_4),
		...
		OBJECT(MODEL_AMP, -11167, -5348, 17062, 0, 0, 0, 0x02000000, bhvCirclingAmp),
		OBJECT(MODEL_NONE, -9127, -7363, 16728, 0, 0, 0, 0x00100000, bhvInstantActiveWarp),
		OBJECT(MODEL_SCUTTLEBUG, -11284, -7638, 16728, 0, 0, 0, 0x00000000, bhvScuttlebug),

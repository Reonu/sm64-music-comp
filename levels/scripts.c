...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_SLIM_PHATTY,              slim_phatty_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SLIM_PHATTY_COLLECTED,    slim_phatty_collected_geo),
    LOAD_MODEL_FROM_GEO(MODEL_NORD_LEAD2,               nordlead2_geo),
    LOAD_MODEL_FROM_GEO(MODEL_NORD_LEAD2_COLLECTED,     nordlead2_collected_geo),
    FREE_LEVEL_POOL(),
...
const LevelScript script_func_global_5[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BOAT,                    boat_geo),
    RETURN(),
};
